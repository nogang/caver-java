...
public abstract class AbstractTxType implements TxType {
     ...
     */
    private ArrayList<KlaySignatureData> senderSignatureData;
    ...
    public AbstractTxType(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit,
        ...
        this.to = to;
        this.value = value;
        this.senderSignatureData = new ArrayList();
    }

    protected void setSenderSignatureData(KlaySignatureData signatureData) {
        senderSignatureData.add(signatureData);
    }

    public ArrayList<KlaySignatureData> getSenderSignatureData() {
