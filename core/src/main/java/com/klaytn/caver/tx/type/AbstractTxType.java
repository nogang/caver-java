...
public abstract class AbstractTxType implements TxType {
     ...
     */
    protected Set<KlaySignatureData> senderSignatureDataSet;
    ...
    public void mergeTxType(AbstractTxType txType) throws Exception {
        byte[] encodedA = this.getEncodedTransactionNoSig();
        byte[] encodedB = txType.getEncodedTransactionNoSig();

        if (Arrays.equals(encodedA, encodedB) != false) {
